...
public class ShoppingMain {
    public static void main(String[] args) {
        ...
        Item blah = new Item("'Java Rules!' button", 0.99, 10, 5.0);
        System.out.println(blah.priceFor(9)); // sb 9 * .99 = 8.91
        System.out.println(blah.priceFor(10)); // sb 10 @ 5.00
        System.out.println(blah.priceFor(12)); // sb 100 / 10 = 10 * 5 = 50 + (1 * .99) = 50.99
    }
}